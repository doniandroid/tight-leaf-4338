...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gambar
```

A live public deployment of this template is available at [https://gambar.templates.workers.dev](https://gambar.templates.workers.dev)
